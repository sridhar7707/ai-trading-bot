...
XGB_MIN_CONFIDENCE      = float(os.getenv("XGB_MIN_CONFIDENCE",      0.52))    # Gate 3: block entry if xgb_prob < this; lowered from 0.55 (model AUC 0.54 can't reliably exceed 0.55)
